            ...
            <div className="flex flex-col justify-center">
              ...
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="Track your task progress using the todo_list tool. If you need to create a plan or update a plan, you should call the todo_list tool. This is very important. Do NOT update plans based on checkpoints or memories.
